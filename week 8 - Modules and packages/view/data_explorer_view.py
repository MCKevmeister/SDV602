...
class des_view(object):
    ...
    def state_closures(self):
        ...
        def set_up_layout(**kwargs):
            ...
            self.components['figures_list'] = sg.Listbox(values=listbox_values, enable_events=True,
        ...
        def render():
            ...
            if self.layout != []:
                self.window = sg.Window('Our Demo Application - Embedding Matplotlib In PySimpleGUI with **kwargs',
                                        self.layout, grab_anywhere=False, finalize=True)
        ...
        return {'set_up_layout': set_up_layout, 'render': render, 'accept_input': accept_input,
                'figure_list_draw': figure_list_draw, 'current_window': self.window}
